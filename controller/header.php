    ...
    <header>
      <nav class="navbar navbar-expand-lg navbar-light bg-783C02 fixed">
        ...
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
          ...
          <span><img class="Hamburger_icon" src="../public/img/Hamburger_icon.svg.png" alt=""></span>
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          ...
          <div class="navbar-nav logo-medium">
            ...
            <img class="panier m-2" src="../public/img/panier-CSLH.png" alt="panier">
            <a class=" nav-item nav-link active font-weight-bold text-white col-1" href="index.php">Accueil<span class="sr-only">(current)</span></a>
